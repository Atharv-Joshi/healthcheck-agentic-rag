...
>
> **Not affiliated with or endorsed by Contentstack.** "Contentstack" appears only to describe what the demo is
> about (its public docs and audit concepts). The UI uses an original color palette and app mark; it does not use
> Contentstack's logo or branding assets.
